...
_DATASETNAME = "ncbi_disease_original"
_DISPLAYNAME = "ncbi_disease_original"
...
class NCBIDisease(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        BigBioConfig(
            name="ncbi_disease_original_source",
            version=_SOURCE_VERSION,
            description="NCBI implementation (datasets) source schema",
            schema="source",
            subset_id="ncbi_orig_source",
        ),
    ]

    DEFAULT_CONFIG_NAME = "ncbi_disease_original_source"
